...
INSERT INTO OrderInfoT
VALUES(
	'HTP20210107659',	    -- 01_销售订单号_主键
	2,			            -- 02_订单状态_已确认收货
	'4387624896647362',	    -- 03_销售订单来源单号
	'郎特姆公司',	    -- 04_经销商名称
	'美拾美客旗舰店',		    -- 05_所属网店（即会员）
	'2020-12-21 20:30:25',	-- 06_订单日期
	'张国厚',				-- 07_买家昵称
	'百世',		            -- 08_快递公司
	'975646748463',		    -- 09_快递单号
	'南京终端仓'			-- 10_发货仓名称
);
INSERT INTO OrderInfoT
VALUES(
	'LFQ20110798486',	    -- 01_销售订单号_主键
	3,			            -- 02_订单状态_已确认收货
	'3865387692774848',	    -- 03_销售订单来源单号
	'金枝玉叶贸易公司',	    -- 04_经销商名称
	'浮生半日书店',		    -- 05_所属网店（即会员）
	'2020-04-17 07:39:20',	-- 06_订单日期
	'石天才',				-- 07_买家昵称
	'韵达',		            -- 08_快递公司
	'646473528274',		    -- 09_快递单号
	'成都双流展柜仓'			-- 10_发货仓名称
);
INSERT INTO OrderInfoT
VALUES(
	'UFW20256373838',	    -- 01_销售订单号_主键
	0,			            -- 02_订单状态_已确认收货
	'5637289487478392',	    -- 03_销售订单来源单号
	'万家乐南京分公司',	    -- 04_经销商名称
	'青锦杂货旗舰店',		    -- 05_所属网店（即会员）
	'2021-01-01 15:26:45',	-- 06_订单日期
	'孙丽萍',				-- 07_买家昵称
	'申通',		            -- 08_快递公司
	'736674892176',		    -- 09_快递单号
	'成都终端仓'			-- 10_发货仓名称
);
INSERT INTO OrderInfoT
VALUES(
	'PNF2020837464859',	    -- 01_销售订单号_主键
	1,			            -- 02_订单状态_已确认收货
	'4743973658957574',	    -- 03_销售订单来源单号
	'成都诚信贸易公司',	    -- 04_经销商名称
	'欧若雅旗舰店',		    -- 05_所属网店（即会员）
	'2020-08-23 13:24:45',	-- 06_订单日期
	'李新元',				-- 07_买家昵称
	'京东',		            -- 08_快递公司
	'873293298737',		    -- 09_快递单号
	'北京终端仓'			-- 10_发货仓名称
);
...
INSERT INTO OrderShippingT
VALUES(
	'HTP20210107659',	    -- 01_订单编号_主键
	'四川省',			    -- 02_收货地址_省
	'成都市',	            -- 03_收货地址_市
	'青羊区',	            -- 04_收货地址_区
	'光华街道30号',		    -- 05_详细收货地址/街道
	'610000',	            -- 06_邮编
	'王璐',				-- 07_收货人
	'16583884738'		    -- 08_收货人手机
);
INSERT INTO OrderShippingT
VALUES(
	'LFQ20110798486',	    -- 01_订单编号_主键
	'湖北省',			    -- 02_收货地址_省
	'武汉市',	            -- 03_收货地址_市
	'武昌区',	            -- 04_收货地址_区
	'黄鹤楼街道',		    -- 05_详细收货地址/街道
	'430000',	            -- 06_邮编
	'李飞',				-- 07_收货人
	'19375847373'		    -- 08_收货人手机
);
INSERT INTO OrderShippingT
VALUES(
	'PNF2020837464859',	    -- 01_订单编号_主键
	'江苏省',			    -- 02_收货地址_省
	'南京市',	            -- 03_收货地址_市
	'江宁区',	            -- 04_收货地址_区
	'麒麟街道23号',		    -- 05_详细收货地址/街道
	'210000',	            -- 06_邮编
	'张三',				-- 07_收货人
	'16973643836'		    -- 08_收货人手机
);
INSERT INTO OrderShippingT
VALUES(
	'UFW20256373838',	    -- 01_订单编号_主键
	'湖北省',			    -- 02_收货地址_省
	'武汉市',	            -- 03_收货地址_市
	'江汉区',	            -- 04_收货地址_区
	'新华街街道20号',		    -- 05_详细收货地址/街道
	'430000',	            -- 06_邮编
	'王云',				-- 07_收货人
	'18476585934'		    -- 08_收货人手机
);

-- 退货信息
INSERT INTO ReturnOrderInfoT
VALUES(
	'UK183746848',	    -- 01_退货订单编号_主键
	'2020-12-20 15:28:51',			    -- 02_退货提交日期
	'GNN2020122113221',	            -- 03_原销售订单号_外键
	3,	            -- 04_退货订单状态
	'上门取件',		    -- 05_退货方式
	'大小尺寸与描述不符',	            -- 06_退货原因
	'韵达',				-- 07_快递公司
...
INSERT INTO ReturnOrderInfoT
VALUES(
	'MQ74829373',	    -- 01_退货订单编号_主键
	'2020-12-03 08:48:57',			    -- 02_退货提交日期
	'JBK2020112900211',	            -- 03_原销售订单号_外键
	1,	            -- 04_退货订单状态
	'自行寄出',		    -- 05_退货方式
	'做工粗糙',	            -- 06_退货原因
	'百世',				-- 07_快递公司
...
INSERT INTO ReturnOrderInfoT
VALUES(
	'KP0857488',	    -- 01_退货订单编号_主键
	'2020-01-09 17:44:17',			    -- 02_退货提交日期
	'KHF2020090700211',	            -- 03_原销售订单号_外键
	5,	            -- 04_退货订单状态
	'自行寄出',		    -- 05_退货方式
	'七天无理由退换',	            -- 06_退货原因
	'顺丰',				-- 07_快递公司
...
INSERT INTO ReturnOrderInfoT
VALUES(
	'DK8492374',	    -- 01_退货订单编号_主键
	'2020-08-01 13:24:15',			    -- 02_退货提交日期
	'SIW2019030700060',	            -- 03_原销售订单号_外键
	6,	            -- 04_退货订单状态
	'上门取件',		    -- 05_退货方式
	'七天无理由退换',	            -- 06_退货原因
	'韵达',				-- 07_快递公司
...
INSERT INTO ReturnOrderInfoT
VALUES(
	'LM9376245',	    -- 01_退货订单编号_主键
	'2020-12-24 20:34:45',			    -- 02_退货提交日期
	'HTP20210107659',	            -- 03_原销售订单号_外键
	1,	            -- 04_退货订单状态
	'自行寄回',		    -- 05_退货方式
	'实物与图片不符',	            -- 06_退货原因
	'百世',				-- 07_快递公司
...
-- 退货详情
INSERT INTO ReturnOrderDetailT
VALUES(
	NULL,		    -- 01_退货ID_自增长
	'UK183746848',			    -- 02_退货订单编号
	'C00205001508',	            -- 03_退货产品编码
	'嵌入式燃气灶',	            -- 04_退货产品名称
	1,		    -- 05_退回数量
	1000	            -- 06_退货金额
);
...
VALUES(
	NULL,		    -- 01_退货ID_自增长
	'MQ74829373',			    -- 02_退货订单编号
	'XY505001293193',	            -- 03_退货产品编码
	'吸油烟机',	            -- 04_退货产品名称
	2,		    -- 05_退回数量
	3000	            -- 06_退货金额
);
...
VALUES(
	'UK183746848',		    -- 01_退货订单编号
	'刘勉励',			    -- 02_审核人名称
	'刘勉励',	            -- 03_审核结算人名称
	'2020-12-25 13:28:51',	            -- 04_审核时间
	'2020-12-25 15:30:23',		    -- 05_审核结算时间
	'商品已损坏'            -- 06_驳回原因
);
INSERT INTO ReturnOrderAuditT
VALUES(
	'MQ74829373',		    -- 01_退货订单编号
	'马仁义',			    -- 02_审核人名称
	'马仁义',	            -- 03_审核结算人名称
	'2020-12-05 16:48:57',	            -- 04_审核时间
	'2020-12-06 09:23:44',		    -- 05_审核结算时间
	'超过七天'            -- 06_驳回原因
);
INSERT INTO ReturnOrderAuditT
VALUES(
	...
	'康志强',			    -- 02_审核人名称
	'康志强',	            -- 03_审核结算人名称
	'2020-01-10 17:44:17',	            -- 04_审核时间
	'2020-01-11 21:56:23',		    -- 05_审核结算时间
	'商品已损坏'            -- 06_驳回原因
);
INSERT INTO ReturnOrderAuditT
VALUES(
	'C00205001508',		    -- 01_退货订单编号
	'郑航',			    -- 02_审核人名称
	'郑航',	            -- 03_审核结算人名称
	'2020-08-02 21:24:15',	            -- 04_审核时间
	'2020-08-04 13:49:56',		    -- 05_审核结算时间
	'同意寄回'            -- 06_驳回原因
);
INSERT INTO ReturnOrderAuditT
VALUES(
	...
	'颜东鑫',			    -- 02_审核人名称
	'颜东鑫',	            -- 03_审核结算人名称
	'2020-12-25 20:34:45',	            -- 04_审核时间
	'2020-12-27 17:38:27',		    -- 05_审核结算时间
	'超过七天'            -- 06_驳回原因
);
